...
public class ProcessPCAOutput1KGBP {
	...
	if (args.length != 5) {
	    System.err.println("[usage] java ProcessPCAOutput1KGBP [fam file] [pop info file] [eigenstrat evec file] [R color file] [outputdir]");
	    System.exit(-1);
	}
	ProcessPCAOutput1KGBP cc = new ProcessPCAOutput1KGBP();
