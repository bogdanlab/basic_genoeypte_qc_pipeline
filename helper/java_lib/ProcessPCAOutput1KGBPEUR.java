...
public class ProcessPCAOutput1KGBPEUR {
	...
	*/
	...
	if (args.length != 5) {
	    System.err.println("[usage] java ProcessPCAOutput1KGBPEUR [fam file] [pop info file] [eigenstrat evec file] [R color file] [outputdir]");
	    System.exit(-1);
	}
	ProcessPCAOutput1KGBPEUR cc = new ProcessPCAOutput1KGBPEUR();
