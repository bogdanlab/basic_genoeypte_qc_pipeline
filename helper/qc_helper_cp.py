...
def pca_plots(config):
    ...
    outlier_file = os.path.join(outdir, os.path.join('6_pca', new_prefix + '.pca_outlier'))
...
def flip_count(config):
    ...
    bim_df['allele_pair'] = bim_df['ALT'] + '/' + bim_df['REF']
